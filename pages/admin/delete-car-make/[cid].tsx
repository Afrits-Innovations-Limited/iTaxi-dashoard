...
const DeleteCarMake = () => {
    ...
    const DeleteCarMakeAPI = `/v1/admin/cars/make/delete/${cid}`
    useEffect(() => {
        setTimeout(() => {
            if (alert) {
                setAlert(false);
    ...
    const handleDelete = async (e: any) => {
        try {
            const response = await Axios.post(DeleteCarMakeAPI, config);
                ...
                <div className='d-flex justify-content-center align-items-center'>
                    <div className="card col-6">
                        ...
                        <div className="card-header">
                            <h3 className="mb-0 card-title">Delete Car Make</h3>
                        </div>
                        <div className="card-body">
                            <div className="row">
                                <div className="">
                                    ...
                                    <br />
                                    <br />
                                    <div className='col-lg-6 fnc-btn align-center'>
